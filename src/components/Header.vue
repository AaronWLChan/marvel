<template>
    <div class=" shadow-lg bg-black py-4 px-6">

        <div class="flex justify-between items-center">
            <svg version="1.1" class="w-24 h-8" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <button class="sm:hidden" @click="toggleMenu">
                <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current text-white h-6 w-6 hover:text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div v-if="menuVisible" class="flex flex-col sm:hidden mt-4 space-y-2">
                <horizontal-link @click="toggleMenu" url="/characters"/>
                <horizontal-link @click="toggleMenu" url="/comics"/>
                <horizontal-link @click="toggleMenu" url="/"/>
