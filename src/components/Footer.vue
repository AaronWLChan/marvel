<template>
    <div class="flex flex-col justify-center items-center py-8 bg-black">

        <svg version="1.1" class="w-48 h-auto mb-4" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <p class="text-xs text-white font-semibold uppercase tracking-widest">Data provided by Marvel. © 2014 Marvel</p>
    </div>
</template>
